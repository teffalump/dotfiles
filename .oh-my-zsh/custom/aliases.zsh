...
#telnet server that broadcasts Star Wars Episode IV as animated text
...
alias pkg-mirror-update="sudo reflector --verbose --sort rate -l 30 -p http --save /etc/pacman.d/mirrorlist"
...
alias gpu='git pull'
alias gcl='git clone'
alias gst='git ls-tree --name-only -r $(git_current_branch)'
